...
async function main(): Promise<void> {
  ...
  const body = [
    ...
    '',
    `Estimate is based on a typical input of ~17,000 tokens and a typical output of ~2,800 tokens at the active model's published rate. Actual cost varies with the campaign's summary length.`,
  ].join('\n');
